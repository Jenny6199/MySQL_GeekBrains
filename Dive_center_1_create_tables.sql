...
-- ТАБЛИЦА № 6 Участие в клубных поездках (Архивная)
...
CREATE TABLE travel_log (
	...
	) ENGINE=Archive AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Таблица участия в клубных поездках';	
...
CREATE TABLE IF NOT EXISTS club_travels_list (
	...
	) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Таблица клубных поездок';
...
CREATE TABLE IF NOT EXISTS status_of_travel (
	...
	status ENUM ('завершено', 'проводится', 'ожидается')
	) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Таблица статусов клубных поездок';
	

-- ТАБЛИЦА № 10 Заявки пользователей на участие в поездках (user_id, № поездки, статус оплаты)
